...
class SessionRegistry:
    ...
    async def get_session_state(self, session_id: str) -> AimontState | None:
        async with self._lock:
    ...
    def _compute_aggregate_state(self) -> AimontState:
        if not self._sessions:
            return AimontState.OFF
